...
button_sub = tk.Button(window, text='-', width=15, height=3)
button_sub.place(x=75, y=375)
button_mul = tk.Button(window, text='*', width=15, height=3)
button_mul.place(x=200, y=300)
button_div = tk.Button(window, text='/', width=15, height=3)
